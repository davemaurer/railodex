...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  describe "POST #create" do
    ...
    let(:valid_attributes) { { address: 'john@terminator.com', contact_id: john.id, contact_type: 'Person' } }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'darkknight@me.com', contact_id: bruce.id, contact_type: 'Person'} }
      let(:new_attributes) { { address: 'super@super.com', contact_id: bruce.id, contact_type: 'Person' } }
