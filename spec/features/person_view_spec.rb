...
describe 'this person view', type: :feature do
  ...
  describe 'phone numbers' do
    ...
    it 'has a link to add a new phone number' do
      expect(page).to have_link('Add new phone number', href: new_phone_number_path(contact_id: person.id, contact_type: 'Person'))
    end
  ...
  describe 'email addresses' do
    ...
    it 'has an add email address link' do
      page.click_link('Add new email address', href: new_email_address_path(contact_id: person.id, contact_type: 'Person'))
